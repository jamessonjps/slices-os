    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-slate-50 dark:bg-slate-950 p-4 transition-colors duration-300 relative">
      ...
      <div className="max-w-md w-full bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-3xl p-5 sm:p-8 shadow-sm mx-2">
        <div className="text-center mb-6 sm:mb-8">
          <div className="bg-black rounded-3xl shadow-lg flex items-center justify-center mx-auto mb-4 border border-slate-800 overflow-hidden w-64 h-32 sm:w-72 sm:h-36 relative">
             <img 
               src={logoUrl} 
               alt="Milano Pizzaria" 
             ...
             />
             <div className="hidden w-full h-full items-center justify-center bg-slate-100 dark:bg-slate-900">
